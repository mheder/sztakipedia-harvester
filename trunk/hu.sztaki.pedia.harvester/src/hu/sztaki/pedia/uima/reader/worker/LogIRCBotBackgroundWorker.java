...
public class LogIRCBotBackgroundWorker extends IRCBotBackgroundWorker {

	public LogIRCBotBackgroundWorker(Wiki wikiAPI, WikiArticleFilter articleFilter, String title,
