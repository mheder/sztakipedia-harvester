...
import hu.sztaki.pedia.uima.reader.util.HTTPWriter;
...
public class HTTPIRCBotBackgroundWorker extends IRCBotBackgroundWorker {
	private HTTPWriter httpWriter;

	public HTTPIRCBotBackgroundWorker(Wiki wikiAPI, WikiArticleFilter articleFilter, String title,
			String applicationName, String language, HTTPWriter httpWriter) {
